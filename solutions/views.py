...
def problem_list_view(request):
    ...
    templates = 'solutions/problem_table.html'
...
def solution_list_view(request):
    ...
    templates = 'solutions/solution_list.html'
    context = {'problems':problems}
    return render(request, templates, context)
...
def adopted_solutions_list_view(request):
    ...
    templates = 'solutions/adopted_solution_list.html'
    context = {'problems':problems}
    return render(request, templates, context)
...
def adopted_solution_view(request, id):
    ...
    templates = 'solutions/adopted_solution.html'
    context = {'problem':problem}
    return render(request, templates, context)
